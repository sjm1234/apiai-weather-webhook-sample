...
def webhook():
    ...
    reqq = urllib.urlopen('http://public-api.adsbexchange.com/VirtualRadar/AircraftList.json?lat=-33.818961&lng=151.105809&fDstL=0&fDstU=10')
    ...
    speech = "Today in 7" + str(readdata)
