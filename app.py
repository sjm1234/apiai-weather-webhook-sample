...
def webhook():
    ...
    if len(planedata["acList"]):
        ...
        speech = "There are " + str(len(planedata["acList"])) + " aircraft within " + str(length) + "km. The closest is " + "kilometers away, " + str(planedata["acList"][place]["Dst"]) + " flight from " + str(planedata["acList"][place]["From"]) + " to " + str(planedata["acList"][place]["To"]) + ". It's a " + str(planedata["acList"][place]["Man"]) + " " + str(planedata["acList"][place]["Type"])# + ". It's a " + str(planedata["acList"][place]["Man"]# + " " + str(planedata["acList"][place]["Type"]
    else:
